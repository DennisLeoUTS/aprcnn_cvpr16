...
BIRD_DIR = '/home/zxu/Dataset/CUB_200_2011/';
...
config.parts = {'bbox','head','body'};
config.N_parts = 3; % bbox + head + body

%config.methods = {'box', 'prior', 'neighbor'};
config.methods = {'box', 'prior'};
config.N_methods = length(config.methods); % three different geometric constaints
