function rcnn_cache_pool5_features_for_weak(imdb, varargin)
...
opts.output_dir = fullfile(opts.cache_name, imdb.name);
...
for i = opts.start:opts.end
  ...
  save_file = fullfile(opts.output_dir, [image_ids{i} '.mat']);
